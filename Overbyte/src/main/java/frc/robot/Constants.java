...
public final class Constants {
    //Drive Train
   // This is defining the ports for the motors.
    ...
    // This is the number of talons that are being used.
    ...
    // This is the button that is used to reset the encoders.
    public static int resetLeftButton = 3;
    public static int resetRightButton = 2;

    // These are the ports for the solenoids.
    ...
    // This is defining the ports for the sensors.
    ...
    // This is a table of values that are used to convert the distance from the target to the angle of
    //     the hood.
    ...
    // Calculating the maximum angular velocity of the robot.
    ...
    // This is the PID values for the shooter.
