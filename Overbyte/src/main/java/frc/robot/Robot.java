...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    ...
    // This is setting the status frame period for all the talons.
  ...
  @Override
  // This is a function that is called every time the robot is disabled. It is used to check the
  // encoders and update the swerve motors.
