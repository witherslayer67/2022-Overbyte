...
public class ShootCommand extends CommandBase {
  ...
  public void execute() {
    ...
    if (!RobotState.isTest()){
      ...
      boolean hasTarget;
      // This is checking if the distance is 0.0, if it is, it will get the values from the angle, if
      // not, it will get the values from the distance.
      if (distance == 0.0){
      ...
      // This is checking if the robot is lined up with the target. If it is, it will reset the storage
      // timer and the timeout timer.
